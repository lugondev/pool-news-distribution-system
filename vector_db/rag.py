...
Pipeline:
  ...
  3. Build a context string from retrieved articles  ← TODO: implement below
...
def build_rag_context(articles: list[dict[str, Any]], lang: str = "en") -> str:
    ...
    Parameters
    ----------
    articles : list of Weaviate article property dicts, ordered by relevance.
               Each dict may contain: title, content, summary_en, summary_vi,
               source_name, published_at, entities, sentiment, url, _score/_distance.
    lang     : target language ("en" or "vi") — determines which summary to prefer.

    Design choices to consider
    --------------------------
    - Use summary (short, clean) vs. content (detailed, may be noisy)?
      Summaries are generated by the AI and are higher quality for Q&A.
      Content may have information the summary omitted.
    - Include source + date metadata?
      Helps the LLM attribute facts: "According to Reuters (2026-03-28)..."
    - Include entities?
      Can help the LLM resolve ambiguous references.
    - How to separate articles?
      Clear delimiters help the LLM avoid mixing up article sources.

    Returns a plain-text context block. Example format:
        [1] BBC News | 2026-03-28
        Title: OpenAI raises $10B from Microsoft
        Summary: OpenAI and Microsoft extended their partnership...

        [2] TechCrunch | 2026-03-27
        Title: ...

    TODO: implement me — aim for ~8-12 lines of formatting logic
    """
    blocks = []
